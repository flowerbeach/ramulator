    ...
    public:
        ...
        struct SpeedEntry {
            ...
            int nCKESR, nXS, nXSDLL;
                ...
                {1600, (400.0 / 3) *
                       6,               1.25, 4, 4, 2, 11, 14, 14, 8, 20, 34, 6, 6, 12, 12, 12, 1, 6240, 4, 5, 20, 5, 0, 512}, //1.2x
                {1600, (400.0 / 3) *
                       6,               1.25, 4, 4, 2, 11, 17, 17, 8, 23, 40, 6, 6, 12, 15, 15, 1, 6240, 4, 5, 20, 5, 0, 512}, //1.5x
                {1600, (400.0 / 3) *
                       6,               1.25, 4, 4, 2, 11, 22, 22, 8, 28, 50, 6, 6, 12, 20, 20, 1, 6240, 4, 5, 20, 5, 0, 512}, //2.0x
        }, speed_entry;
