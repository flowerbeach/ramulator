    ...
    public:
        ...
        struct SpeedEntry {
            ...
            int nSR, nXSR; // tXSR = tRFCab + 7.5ns
                ...
                {1600, 400.0 * 2, 2.5 / 2, 8, 8, 2, 1, 15 + 3, 15, 15 - 2, 17 - 2, 8 + 3,  34, 47, 8 + 2,  8,
                                                                                                               15 -
                                                                                                               1,      4, 8,  32, 0, 0, 0, 0, 6,  12, 0},
                {2400, 400.0 * 3, 2.5 / 3, 8, 8, 2, 2, 22 + 3, 22, 22 - 2, 26 - 2, 11 + 3, 51, 71, 9 + 2,  12, 22 -
                                                                                                               1,      4, 12, 48, 0, 0, 0, 0, 9,  18, 0},
                {3200, 400.0 * 4, 2.5 / 4, 8, 8, 2, 3, 29 + 3, 29, 29 - 2, 34 - 2, 15 + 3, 68, 95, 12 + 2, 16, 29 -
                                                                                                               1,      4, 16, 64, 0, 0, 0, 0, 12, 24, 0}
        }, speed_entry;
