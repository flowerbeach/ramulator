    ...
    public:
        ...
        struct SpeedEntry {
            ...
            int nSCD;
                ...
                {800,  (400.0 / 3) * 3, (3 / 0.4) /
                                        3,             4, 4, 2, 5,  5,  5,  1, 5,  15, 20, 4, 4, 6,  3, 12, 0, 0, 0, 3120, 3, 3, 10, 4, 0, 512, 1},
                {800,  (400.0 / 3) * 3, (3 / 0.4) /
                                        3,             4, 4, 2, 6,  6,  6,  1, 5,  15, 21, 4, 4, 6,  3, 12, 0, 0, 0, 3120, 3, 3, 10, 4, 0, 512, 1},
                {1066, (400.0 / 3) * 4, (3 / 0.4) /
                                        4,             4, 4, 2, 6,  6,  6,  1, 6,  20, 26, 4, 4, 8,  3, 14, 0, 0, 0, 4160, 3, 4, 13, 4, 0, 512, 1},
                {1066, (400.0 / 3) * 4, (3 / 0.4) /
                                        4,             4, 4, 2, 7,  7,  7,  1, 6,  20, 27, 4, 4, 8,  4, 14, 0, 0, 0, 4160, 3, 4, 13, 4, 0, 512, 1},
                {1066, (400.0 / 3) * 4, (3 / 0.4) /
                                        4,             4, 4, 2, 8,  8,  8,  1, 6,  20, 28, 4, 4, 8,  4, 14, 0, 0, 0, 4160, 3, 4, 13, 4, 0, 512, 1},
                {1333, (400.0 / 3) * 5, (3 / 0.4) /
                                        5,             4, 4, 2, 8,  8,  8,  1, 7,  24, 32, 5, 5, 10, 4, 16, 0, 0, 0, 5200, 4, 4, 16, 5, 0, 512, 1},
                {1333, (400.0 / 3) * 5, (3 / 0.4) /
                                        5,             4, 4, 2, 9,  9,  9,  1, 7,  24, 33, 5, 5, 10, 5, 16, 0, 0, 0, 5200, 4, 4, 16, 5, 0, 512, 1},
                {1600, (400.0 / 3) * 6, (3 / 0.4) /
                                        6,             4, 4, 2, 9,  9,  9,  1, 8,  28, 37, 6, 6, 12, 5, 18, 0, 0, 0, 6240, 4, 5, 20, 5, 0, 512, 1},
                {1600, (400.0 / 3) * 6, (3 / 0.4) /
                                        6,             4, 4, 2, 10, 10, 10, 1, 8,  28, 38, 6, 6, 12, 5, 18, 0, 0, 0, 6240, 4, 5, 20, 5, 0, 512, 1},
                {1600, (400.0 / 3) * 6, (3 / 0.4) /
                                        6,             4, 4, 2, 11, 11, 11, 1, 8,  28, 39, 6, 6, 12, 6, 18, 0, 0, 0, 6240, 4, 5, 20, 5, 0, 512, 1},
                {1866, (400.0 / 3) * 7, (3 / 0.4) /
                                        7,             4, 4, 2, 11, 11, 11, 1, 9,  32, 43, 7, 7, 14, 6, 20, 0, 0, 0, 7280, 5, 6, 23, 6, 0, 512, 1},
                {1866, (400.0 / 3) * 7, (3 / 0.4) /
                                        7,             4, 4, 2, 12, 12, 12, 1, 9,  32, 44, 7, 7, 14, 6, 20, 0, 0, 0, 7280, 5, 6, 23, 6, 0, 512, 1},
                {2133, (400.0 / 3) * 8, (3 / 0.4) /
                                        8,             4, 4, 2, 12, 12, 12, 1, 10, 36, 48, 8, 8, 16, 6, 22, 0, 0, 0, 8320, 6, 7, 26, 7, 0, 512, 1},
                {2133, (400.0 / 3) * 8, (3 / 0.4) /
                                        8,             4, 4, 2, 13, 13, 13, 1, 10, 36, 49, 8, 8, 16, 7, 22, 0, 0, 0, 8320, 6, 7, 26, 7, 0, 512, 1}
        }, speed_entry;
