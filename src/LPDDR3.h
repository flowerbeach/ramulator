    ...
    public:
        ...
        struct SpeedEntry {
            ...
            int nCKESR, nXSR; // tXSR = tRFCab + 10ns
                ...
                {1333, (400.0 / 3) * 5,
                                        (3 / 0.4) /
                                        5,             4, 4, 2, 2, 10, 12, 12, 14, 6, 28, 40, 5, 5, 10, 7,  34, 0, 0, 2600, 5, 5, 10, 0},
                {1600, (400.0 / 3) * 6, (3 / 0.4) /
                                        6,             4, 4, 2, 2, 12, 15, 15, 17, 6, 34, 48, 6, 6, 12, 8,  40, 0, 0, 3120, 6, 6, 12, 0},
                {1866, (400.0 / 3) * 7, (3 / 0.4) /
                                        7,             4, 4, 2, 3, 14, 17, 17, 20, 8, 40, 56, 7, 7, 14, 10, 47, 0, 0, 3640, 7, 7, 14, 0},
                {2133, (400.0 / 3) * 8, (3 / 0.4) /
                                        8,             4, 4, 2, 3, 16, 20, 20, 23, 8, 45, 64, 8, 8, 16, 11, 54, 0, 0, 4160, 8, 8, 16, 0}
        }, speed_entry;
